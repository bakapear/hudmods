...
function canBounce (height, vel, interval) {
  ...
  if (b) {
    ...
    if (raw >= DRANGE[0] && raw <= DRANGE[1]) b = 2
  }
  // console.log({ res: Number(b), hmax: heightmax, hmin: heightmin, tmax: tickmax, tmin: tickmin })
  return Number(b)
}
...
main.checkBounce(100, { vel: -6 }, main.UNCROUCHED)
main.checkBounce(97, { vel: -6 }, main.UNCROUCHED)
main.checkBounce(102, { vel: -6 }, main.UNCROUCHED)
main.checkBounce(4832, { vel: 483 }, main.UNCROUCHED)
